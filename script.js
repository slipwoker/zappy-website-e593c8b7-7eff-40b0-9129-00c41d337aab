    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            if (input.hasAttribute('required') && !value) {
                const fieldName = input.getAttribute('data-name') || input.placeholder || input.name;
                showError(input, (fieldName ? fieldName : 'This field') + ' is required.');
                return false;
            }
            ...
            if (isValid) {
                ...
                .then(function(response) {
                    if (response.ok) {
                        ...
                        successMsg.style.backgroundColor = '#f0fff4';
                        successMsg.style.borderRadius = '0.375rem';
                ...
                .catch(function(error) {
                    ...
                    errorMsg.style.borderRadius = '0.375rem';
                    
                    const existingError = contactForm.querySelector('.form-error-global');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e593c8b7-7eff-40b0-9129-00c41d337aab',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e593c8b7-7eff-40b0-9129-00c41d337aab';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e593c8b7-7eff-40b0-9129-00c41d337aab';
